...
partial class MainPageVM : BaseVM
{
    ...
    private readonly News newsModel = new();
    private readonly Weather weatherModel = new();
    ...
    private DateTime taskDate = new(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day);
